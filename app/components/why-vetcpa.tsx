      ...
      <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
        <div className="px-6 pb-24 pt-16 sm:pb-32 sm:pt-20 lg:col-start-2 lg:px-8 lg:pt-32">
          <div className="mx-auto max-w-2xl lg:mr-0 lg:max-w-lg">
            <h2 className="text-base/8 font-semibold text-red-600">Why VetCPA?</h2>
            <p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
              Trusted by veterinarians across Canada
            </p>
            <p className="mt-6 text-lg/8 text-gray-600">
              At the core of our mission lies a deep commitment to supporting veterinarians in realizing their financial
