...
const navigation = {
  solutions: [
    { name: "GST/HST Registration", href: "#" },
    { name: "Tax Deadlines & Planning", href: "#" },
    { name: "Expense Management", href: "#" },
    { name: "Vehicle Expenses", href: "#" },
    { name: "Professional Invoicing", href: "#" },
    { name: "Incorporation Guidance", href: "#" },
  ],
  support: [
    { name: "Mileage Tracking Template ", href: "#" },
    { name: "Professional Invoice Templates ", href: "#" },
    { name: "Expense Tracking Spreadsheet", href: "#" },
    { name: "Tax Deadline Calendar ", href: "#" },
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl">
            Start mastering your veterinary locum finances today.
          </p>
